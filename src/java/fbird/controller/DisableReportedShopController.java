 ...
 * @author Louis
 */
public class DisableReportedShopController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ShopDTO disable = new ShopDTO(username, status);
            boolean checkDisable = dao.disableShopAccount(disable);
            if (checkDisable) {
                url = SUCCESS;
            }
        } catch (Exception e) {
            log("ERROR at DisableReportedShopController: " + e.toString());
        } finally {
