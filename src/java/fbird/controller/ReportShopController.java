 ...
 * @author Admin
 */
public class ReportShopController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ReportedShopDTO addreportshop = new ReportedShopDTO(shop_id, customer_id, detail);
            dao.addReportShop(addreportshop);
        } catch (Exception e) {
            e.printStackTrace();
