 ...
 * @author Admin
 */
public class ViewRecipeOnShopController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<RecipeDTO> list = dao.getRecipe(shop_id);
            if(!list.isEmpty()){
            ...
            request.getRequestDispatcher("AllRecipe.jsp").forward(request, response);
        }
    }
